...
import type { GetUsersResponse, UserActionResponse, UserLoginRequest, UserLoginResponse, UserRegisterRequest, UserRegisterResponse } from "./types";
...
export function register(data: UserRegisterRequest) {
  const res = axios.post<UserRegisterResponse>(`${base_url}/users/register`, data);
  return res;
}
